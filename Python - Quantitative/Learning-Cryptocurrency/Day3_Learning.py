...
# 回测参数
# 注意参加前三名的同学，需要保持下方选币数量1，杠杆比例1，以及起始和截止时间21-01-01到24-07-01
...
factor_class_dict = {'Bias_9':False}

# 导入数据
df = pd.read_csv(f'/Users/lyndonbin/Downloads/VS_Code/Python/Python - Quantitative/Learning-Cryptocurrency/day3代码/all_coin_factor_data_24H.csv', encoding='gbk', parse_dates=['time'])
