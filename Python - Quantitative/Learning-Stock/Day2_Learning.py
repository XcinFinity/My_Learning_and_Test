...
stock_code_list = ['sh600519', 'sh601398', 'sh601857','sh600941','sh601288',
                   'sh601939','sh601988','sh600938','sh601088','sh600036'] #在后面添加,' '即可，注意一定要用英文符号
...
# =====保存数据
df.to_csv('Lyndon_YXC_stock_data.csv', index=False)
